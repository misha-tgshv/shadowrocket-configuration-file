...
* domain_antifilter.list — домены из списка сообщества [Антифильтр](https://community.antifilter.download) исключен;
...
## Поддержка
Оперативное обсуждение конфигов, настроек и возможностей в телеграм-чате [«Про Shadowrocket на русском»](https://t.me/shadowrocket_ru). 
